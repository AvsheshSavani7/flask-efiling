...
""".strip()
    ...
    elif case_type.upper() == "COMESA":
        context_info = "COMESA Competition Commission merger case"
    ...
    elif case_type.upper() == "BWB AUSTRIA":
        context_info = (
            "Austrian Federal Competition Authority (Bundeswettbewerbsbehörde, BWB) "
            "merger notification (Zusammenschluss)"
        )
